...
namespace Conduit.Mediator.DependencyInjection;

/// <summary>
/// Extension methods for configuring Conduit.Mediator services.
/// </summary>
public static class ServiceCollectionExtensions
{
    /// <summary>
    /// Registers Conduit.Mediator services with the service collection.
    /// </summary>
    ...
    /// <summary>
    /// Registers Conduit.Mediator services and scans assemblies for handlers.
    /// </summary>
    /// <param name="services">Service collection</param>
    ...
    /// <summary>
    /// Registers Conduit.Mediator services and scans the calling assembly for handlers.
    /// </summary>
    /// <param name="services">Service collection</param>
    /// <param name="configure">Optional configuration action</param>
    /// <param name="lifetime">Service lifetime for handlers (default: Transient)</param>
    ...
    /// <summary>
    /// Registers Conduit.Mediator services and scans the assembly containing the specified type for handlers.
    /// </summary>
    /// <param name="services">Service collection</param>
